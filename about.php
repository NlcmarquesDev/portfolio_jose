...
<div class="wil-content">
	...
	<section class="awe-section bg-gray">
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-lg-5 "><img class="rounded-circle" src="assets/images/myself.png" alt="">
				</div>
				<div class="col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-0 col-lg-offset-1 ">
					...
					<div class="mt-30">
						...
						<p class="about__text">👋 Junior Full Stack Developer passionate about technology and innovation.<br />
							I love transforming ideas into functional and intuitive web applications, always seeking the best solutions for each challenge.<br />
							My development journey has taken me to Belgium, where the adventure of living in a new country has inspired me to set new goals and explore new paths.<br />
							I believe that curiosity and the willingness to learn are the keys to creating quality software.<br />
							Let's build something amazing together!</p>

						<!-- about -->
						<div class="mt-3">
							<h5 class="about__title mb-5">Frontend Skills</h5>
